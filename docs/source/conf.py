...
Notes:
    ...
    cd ~/code/pyhaos/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/pyhaos/docs/source/auto ~/code/pyhaos/pyhaos
    ...
    Also:
        ...
        Enter the following information:
            Set the Repository NAME: pyhaos
        ...
        For gitlab you also need to setup an integrations. Navigate to:
            ...
            https://readthedocs.org/dashboard/pyhaos/integrations/create/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/pyhaos/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'pyhaos')
...
# html_logo = '.static/pyhaos.svg'
# html_favicon = '.static/pyhaos.ico'
...
latex_documents = [
    (master_doc, 'pyhaos.tex', 'pyhaos Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyhaos', 'pyhaos Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyhaos', 'pyhaos Documentation',
     author, 'pyhaos', 'One line description of project.',
     'Miscellaneous'),
]
